                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <ul class="nav nav-tabs" style="padding: 1rem">
                            ...
                            <li class="nav-item">
                                <a href="#{{ $setting_key }}" data-toggle="tab" aria-expanded="false"
                                    class="nav-link <?php if ($tab == 1) {
                                        echo 'active';
                                            ...
                                            foreach (json_decode($setting_name['option_value']) as $option_name => $option_value) {
                                                ...
                                                if ($setting_name['value'] == $option_value) {
                                                    ...
                                                    $sel="";
                                                        ...
                                                        <option style="text-align: left;" value="<?= $option_value ?>"
                                                            <?= $sel ?>><?php echo trans('view_pages.' . $option_name); ?></option>
                                                        <?php
                                            } ?>
                                                    </select>
                                                    <?php }
                      /*text box*/      elseif ($setting_name['field']=="text") { ?>
                                          ...
                                          elseif ($setting_name['field']=="password") { ?>
                                                    <input name="<?= $setting_name['name'] ?>" type="password"
                                                        value="<?= env('APP_FOR') === 'demo' ? '**********' : $setting_name['value'] ?>"
                                            ...
                                            <div class="file-tab panel-body"> --}}
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-6">
                                                            ...
                                                            <input type="file" id="{{ $setting_name['name'] }}"
                                                                onchange="readURL(this)" name="{{ $setting_name['name'] }}"
                                                            ...
                                                            <span
                                                                class="text-danger">{{ $errors->first($setting_name['name']) }}</span>
                                                        </div>
                                                    </div>
