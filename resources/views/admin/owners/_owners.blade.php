                                ...
                                @foreach ($results as $key => $result)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif --}}
                                            @if ($result->owner_unique_id != null && $result->approve == 1)
                                                <a class="dropdown-item sweet-approval btn btn-primary btn-sm" href="#" data-url="{{ url('admins/approve', $result->user->id) }}" style="background-color: green;width: 100px;">
                                                    @lang('view_pages.approved')
                                                </a>
                                            @else
                                                <a class="dropdown-item sweet-approval btn btn-danger btn-sm" href="#" data-url="{{ url('admins/approve', $result->user->id) }}" style="width: 100px;">
                                        ...
                                        <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
                                            ...
                                            @if(auth()->user()->can('edit-owner'))
                                                <a class="dropdown-item" href="{{url('owners/edit',$result->id)}}">
