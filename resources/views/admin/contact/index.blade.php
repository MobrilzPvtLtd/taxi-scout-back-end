...
<div class="row">
    <div class="col-12">
        ...
        <div id="js-contact-partial-target">
            <include-fragment src="contact/fetch">
...
<script>
    ...
    $('body').on('click', '.pagination a', function(e) {
        ...
        $.get(url, $('#search').serialize(), function(data){
            $('#js-contact-partial-target').html(data);
        });
    });
    ...
    $('#search').on('click', function(e){
        e.preventDefault();
            ...
            fetch('contact/fetch?search='+search_keyword)
            .then(response => response.text())
            .then(html=>{
                document.querySelector('#js-contact-partial-target').innerHTML = html
            });
    });
});
