                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('subscription/update', $item->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="package_name" name="package_name"
                                                value="{{ $item->package_name }}" required
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="number_of_drivers"
                                                name="number_of_drivers" value="{{ $item->number_of_drivers }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="validity"
                                                name="validity" value="{{ $item->validity }}"
