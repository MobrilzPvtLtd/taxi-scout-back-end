                                ...
                                @if ($item->driverDetail)
                                    ...
                                    <div class="col-5 my-3">
                                        <a href="{{ $item->driverDetail->profile_picture }}" data-fancybox>
                                            <img class="img-fluid" src="{{ $item->driverDetail->profile_picture }}"
                                                alt="">
                                        </a>
                                    </div>
                                ...
                                @if ($item->zoneType->vehicleType)
                                    ...
                                    <div class="col-5 my-3">
                                        <a href="{{ $item->zoneType->vehicleType->icon }}" data-fancybox>
                                            <img class="img-fluid" src="{{ $item->zoneType->vehicleType->icon }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="col-7 my-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="mb-1 f-12">
                                        ...
                                        <b>{{ $item->adHocuserDetail->name ?? $item->userDetail->name }}</b>
                                    </p>
                                    @if (env('APP_FOR') == 'demo')
                                        <p class="mb-1 f-12">
                                            @lang('view_pages.phone') : <b>*********</b>
                                    ...
                                    @else
                                        <p class="mb-1 f-12">
                                            ...
                                            <b>{{ $item->adHocuserDetail->mobile ?? $item->userDetail->mobile }}</b>
                                        </p>
                                    @endif
                                </div>
