                                    ...
                                    @if(auth()->user()->id == 1)
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="owner_id">Taxi Company<span class="text-danger">*</span></label>
                                                <select name="owner_id" id="owner_id" class="form-control" required>
                                                    <option value="" selected disabled>Select Taxi Company</option>
                                                    @foreach ($admin as $company)
                                                        <option value="{{ $company->owner_unique_id }}" {{ $company->owner_unique_id == $type->owner_id ? 'selected' : null }}>{{ $company->name }}</option>
                                                    @endforeach
                                                </select>
