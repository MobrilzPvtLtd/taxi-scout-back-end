                        ...
                        <div class="col-sm-12">
                            <form method="post" class="form-horizontal" action="{{ url('admins/update', $item->id) }}"
                                            ...
                                            <select name="role" id="role" class="form-control"
                                                ...
                                                @foreach ($roles as $key => $role)
                                                    <option value="{{ $role->slug }}"
                                                        {{ old('role', $item->user->roles[0]->slug) == $role->slug ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="package_id" id="package_id"  class="form-control"
                                                ...
                                                @foreach (App\Models\Admin\Subscription::get() as $key => $subscription)
                                                    <option value="{{ $subscription->id }}" {{ $subscription->id == $order->package_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="company_name" name="company_name"
                                                value="{{ old('company_name', $item->company_name) }}" required=""
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="password">@lang('view_pages.password') <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" type="password" id="password" name="password" value="{{ old('password', $item->password) }}" placeholder="@lang('view_pages.enter_password')">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" id="password_confirmation"
                                                ...
                                                value="{{ old('password_confirmation', $item->password) }}" placeholder="@lang('view_pages.enter_password_confirmation')">
                                            <span class="text-danger">{{ $errors->first('password') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <select name="country" id="country" class="form-control" required>
                                                ...
                                                @foreach ($countries as $key => $country)
                                                    <option value="{{ $country->dial_code }}"
                                                        {{ $item->user->country == $country->dial_code ? 'selected' : '' }}>
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="city">@lang('view_pages.Zone') <span
                                                    class="text-danger">*</span></label>
