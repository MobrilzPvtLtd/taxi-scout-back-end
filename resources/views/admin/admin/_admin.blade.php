                    ...
                    @foreach ($results as $key => $result)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <a class="dropdown-item sweet-approval btn btn-warning btn-sm" href="#" data-url="{{ url('admins/approve', $result->user->id) }}">
                                    ...
                                    @if (auth()->user()->can('toggle-admin-status'))
                                        @if ($result->user->active)
                                            <a class="dropdown-item"
                                                href="{{ url('admins/toggle_status', $result->user->id) }}">
