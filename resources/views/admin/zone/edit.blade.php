                                            ...
                                            <select name="admin_id" id="zone_admin" class="form-control" required>
                                                ...
                                                @foreach ($services as $key => $service)
                                                    <option value="{{ $service->id }}"
                                                        {{ $service->id == $zone->service_location_id ? 'selected' : '' }}>
                                                        {{ $service->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="owner_id" id="owner_id" class="form-control" required>
                                                    ...
                                                    <option value="{{ $company->owner_unique_id }}" {{ $company->owner_unique_id == $zone->owner_id ? 'selected' : null }}>{{ $company->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="zone_name" type="text" name="zone_name"
                                                value="{{ old('name', $zone->name) }}" placeholder="@lang('view_pages.enter_name')"
                                                required>
