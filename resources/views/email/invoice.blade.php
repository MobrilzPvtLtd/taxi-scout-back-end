...
">
                                                                                                                                                    ...
                                                                                                                                                    for
                                                                                                                                                    <br>
                                                                                                                                                    {{ $data->requestBill->total_distance ? number_format($data->requestBill->total_distance - $data->requestBill->base_distance, 2) : 0.0 }}
                                                                                                                                                    KM
                                                                                                                                                </td>
                                                                                                                                            </tr>
                                                                                                                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td border="0" cellpadding="0" cellspacing="0" valign="top"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0"
                                                        width="50%" style="width: 50%" align="left">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding: 0 0 0 0">
                                                                    <table cellpadding="0" cellspacing="0"
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0"
                                                        width="27%" style="width: 27%" align="right">
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding: 0 0 0 0">
                                                                    <table cellpadding="0" cellspacing="0"
