...
class EtaTransformer extends Transformer
{
    ...
    public function transform(ZoneType $zone_type)
    {
        ...
        $response =  [
			...
			'smoking'=> $zone_type->vehicleType->smoking,
			 'pets'=> $zone_type->vehicleType->pets,
			 'drinking'=> $zone_type->vehicleType->drinking,
			 'handicaped'=> $zone_type->vehicleType->handicaped,
        ...
        if (!request()->has('vehicle_type')) {
			...
			//$response['smoking'] = $zone_type->smoking;
			//$response['pets'] = $zone_type->pets;
		    //$response['drinking'] = $zone_type->drinking;	
			//$response['handicaped'] = $zone_type->handicaped;
		...
		//print_r($zone_type->vehicleType->smoking); exit;
       return $response;
    }
