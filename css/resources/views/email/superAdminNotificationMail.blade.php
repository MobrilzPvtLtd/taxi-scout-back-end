                ...
                <tbody>
                    <tr>
                        <td style="padding: 24px 32px 30px;">
                            <p style="font-size: 14px; padding-bottom: 10px; margin: 0; color: #000;">Hello {{ $data['admin_name'] }},</p>

                            <p style="font-size: 14px; padding-bottom: 10px; margin: 0; color: #000;">A New Notification for Company Ragistered</p>
